...
#
# This version reads from a Fabric table (pmt_lands_dataflow_authorizationid_piesid)
...
TABLE_NAME = "testETL_lakehouse.pmt_lands_dataflow_authorizationid_piesid"

# Point to the Files folder in your Lakehouse
RULES_PATH = "/lakehouse/default/Files/lands/rules_land.json"
LIFECYCLE_PATH = "/lakehouse/default/Files/lands/lifecycle_map.json"

# Write output back under Files/pies_output
OUTPUT_DIR = "/lakehouse/default/Files/pies_output"
timestamp = datetime.now().strftime("%Y%m%d")
OUTPUT_FILENAME = f"lands_events_{timestamp}.jsonl"

API_URL = "https://nr-peach-dev-main-api.azurewebsites.net/api/v1/records/"
