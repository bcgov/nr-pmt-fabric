...
# Adjust these paths/names for your environment:
TABLE_NAME = "query_trackingnumber_piesid"  # <- your Fabric table/view
RULES_PATH = "rules.json"                  # e.g. "Files/rules.json" in Lakehouse
LIFECYCLE_PATH = "lifecycle_map.json"      # e.g. "Files/lifecycle_map.json"
OUTPUT_DIR = "out"                         # e.g. "Files/pies_output"
OUTPUT_FILENAME = "events_trackingnumber.jsonl.gz"  # can be ".jsonl" or ".jsonl.gz"
